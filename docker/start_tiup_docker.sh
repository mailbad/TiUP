...
docker run -itd --restart=always --net zert --dns 10.21.1.205 --add-host xkimserverupdate.demo.tiup.ren:172.18.0.1 --add-host xk-imserver.demo.tiup.ren:127.0.0.1 --name xk-imserver -h xk-imserver -v /data/docker_run/xk-pomelo:/tiup -p 2132:22 -p 3011:3011  -p 3052:3052 -p 3001:3001 -p 4001:4001 tiup:imserver
}
